...
T = TypeVar("T", bound="ComponentOptionsSIPSIPCredentials")


@_attrs_define
class ComponentOptionsSIPSIPCredentials:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        component_options_sipsip_credentials = cls(
            address=address,
            password=password,
            username=username,
        )

        component_options_sipsip_credentials.additional_properties = d
        return component_options_sipsip_credentials
