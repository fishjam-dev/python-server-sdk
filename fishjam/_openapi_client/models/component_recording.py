...
if TYPE_CHECKING:
    from ..models.component_properties_recording import ComponentPropertiesRecording
    from ..models.track import Track


T = TypeVar("T", bound="ComponentRecording")
...
class ComponentRecording:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        properties = ComponentPropertiesRecording.from_dict(d.pop("properties"))
        ...
        component_recording.additional_properties = d
        return component_recording
