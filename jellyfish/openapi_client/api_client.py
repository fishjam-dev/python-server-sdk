...
import jellyfish.openapi_client.models
from jellyfish.openapi_client import rest
from jellyfish.openapi_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(jellyfish.openapi_client.models, klass)
